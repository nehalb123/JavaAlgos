...
public class TopKFrequentElements {
    ...
    static int[] topKUsingHeap(int nums[], int k){
        count = new HashMap();
        for(int num: nums){
    ...
    public static void quickSelect(int left, int right, int k_smallest) {
        ...
        */
        ...
        // find the pivot position in a list
    ...
    public static void main(String[] args) {
        ...
        int topKUsingHeap[] = topKUsingHeap(arr, k);
        System.out.println("Top K frequent elements are: ");
        Arrays.stream(topk).forEach(elem ->  System.out.print(elem + " "));
        System.out.println();
        Arrays.stream(topKUsingHeap).forEach(elem ->  System.out.print(elem + " "));
    }
